...
"""
    ...
    def _extract_typescript_function(file_path: str, target_line: int) -> str:
        ...
        Source Identification records exact TypeScript function ranges and
        source text.  Prefer those records; use balanced braces only when an
